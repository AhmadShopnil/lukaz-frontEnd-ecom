...
const ReviewCard = ({ review }) => (
  <div className="bg-white p-4 rounded-lg border border-gray-200 min-h-[200px] flex flex-col">
    ...
    <h3 className="font-semibold text-gray-900 mb-2 text-sm leading-tight">{review.title}</h3>

    <p className="text-gray-700 text-sm leading-relaxed mb-4 flex-grow">{review.content}</p>
    ...
    <div className="max-w-6xl mx-auto p-6 bg-gray-50">
      ...
      <div className="text-center mb-6">
        <p className="text-gray-700 text-sm">
          Rated <span className="font-semibold">4.6</span> / 5 based on <span className="font-semibold">86,299</span>{" "}
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-4">
        <div className="flex items-center justify-center gap-4">
          ...
          <span className="text-gray-700">86,299 reviews on</span>
          <div className="flex items-center gap-1">
            <StarIcon />
